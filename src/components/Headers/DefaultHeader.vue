<template>
  ...
  <a-layout-header>
      ...
      <a-menu mode="horizontal" class="menu-large">
        ...
        <a-menu-item>
          <router-link to="/sign-up" class="nav-link" @click="e => e.preventDefault()">
            <svg width="14px" height="14px" class="fill-muted" viewBox="0 0 14 14" version="1.1"
                 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g class="fill-muted" id="Tables" transform="translate(-58.000000, -507.000000)" fill="#BFBFBF"
                   fill-rule="nonzero">
        ...
        <a-collapse v-model="collapseNav" accordion>
          <a-collapse-panel key="1">
            ...
            <a-menu mode="vertical">
              ...
              <a-menu-item>
                <router-link to="/sign-up" class="nav-link" @click="e => e.preventDefault()">
                  <svg width="20" height="20" class="fill-muted" viewBox="0 0 14 14" version="1.1"
                       xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                      <g class="fill-muted" id="Tables" transform="translate(-58.000000, -507.000000)" fill="#BFBFBF"
                         fill-rule="nonzero">
    ...
    <div class="header-col header-btn">
      <a-button href="https://www.creative-tim.com/product/muse-vue-ant-design-dashboard" target="_blank" type="primary"
                shape="round">FREE DOWNLOAD
      </a-button>
    </div>
  </a-layout-header>
  <!-- / Layout Header ( Navbar ) -->
